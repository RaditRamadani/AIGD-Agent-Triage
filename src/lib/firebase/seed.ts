...
const facilities = [
  ...
  // ── Jombang Facilities ──
  {
    name: 'RSUD Kabupaten Jombang — IGD',
    type: 'IGD',
    address: 'Jl. KH. Wahid Hasyim No.52, Jombang',
    location: { lat: -7.5501, lng: 112.2331 },
    phone: '0321-863502',
    operating_hours: '24 Jam',
    services: ['IGD 24 Jam', 'Bedah', 'ICU', 'Radiologi'],
    available_slots: [],
  },
  {
    name: 'RSUD Ploso — IGD',
    type: 'IGD',
    address: 'Jl. Raya Ploso - Babat No.45, Ploso, Jombang',
    location: { lat: -7.4589, lng: 112.2335 },
    phone: '0321-888615',
    operating_hours: '24 Jam',
    services: ['IGD 24 Jam', 'Trauma Center', 'Persalinan'],
    available_slots: [],
  },
  {
    name: 'RS Islam Jombang',
    type: 'Klinik',
    address: 'Jl. Pesantren No.1, Jombang',
    location: { lat: -7.5461, lng: 112.2431 },
    phone: '0321-861060',
    operating_hours: '08:00–21:00',
    services: ['Poli Umum', 'Poli Anak', 'Laboratorium', 'Fisioterapi'],
    available_slots: generateSlots(dateStr, 8, 21),
  },
  {
    name: 'Puskesmas Jombang Kota',
    type: 'Puskesmas',
    address: 'Jl. Pandanwangi No.10, Jombang',
    location: { lat: -7.5441, lng: 112.2300 },
    phone: '0321-861111',
    operating_hours: '08:00–14:00',
    services: ['Poli Umum', 'Poli Gigi', 'KIA', 'Imunisasi'],
    available_slots: generateSlots(dateStr, 8, 14),
  ...
  {
    name: 'Puskesmas Peterongan',
    type: 'Puskesmas',
    address: 'Jl. Raya Peterongan, Jombang',
    location: { lat: -7.5448, lng: 112.2750 },
    phone: '0321-862222',
    operating_hours: '08:00–15:00',
    services: ['Poli Umum', 'KIA', 'Rawat Inap Ringan'],
    available_slots: generateSlots(dateStr, 8, 15),
  },
  {
    name: 'Puskesmas Mojoagung',
    type: 'Puskesmas',
    address: 'Jl. Raya Mojoagung No.1, Jombang',
    location: { lat: -7.5752, lng: 112.3361 },
    phone: '0321-863333',
    operating_hours: '24 Jam (UGD)',
    services: ['UGD', 'Rawat Inap', 'Poli Umum', 'KIA'],
    available_slots: generateSlots(dateStr, 8, 16),
  },
  {
    name: 'Puskesmas Cukir',
    type: 'Puskesmas',
    address: 'Jl. Raya Cukir No.15, Diwek, Jombang',
    location: { lat: -7.5937, lng: 112.2331 },
    phone: '0321-864444',
    operating_hours: '08:00–14:00',
    services: ['Poli Umum', 'KIA', 'Farmasi'],
    available_slots: generateSlots(dateStr, 8, 14),
  },
];
